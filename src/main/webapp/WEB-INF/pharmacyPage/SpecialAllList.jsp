  ...
  <table class="tablelist">
    ...
    <tr>
      ...
      <td colspan="9" align="right">
        <a href="/anesthesia/anesthesiaAllList.action?pageNum=1"    target="main">首页</a>
        <a href="/anesthesia/anesthesiaAllList.action?pageNum=${specialAllPageList.prePage}"  target="main">上一页</a>
        <a href="/anesthesia/anesthesiaAllList.action?pageNum=${specialAllPageList.nextPage}"  target="main">下一页</a>
        <a href="/anesthesia/anesthesiaAllList.action?pageNum=${specialAllPageList.navigateLastPage}"  target="main">尾页</a>
      </td>
    </tr> 
    </tbody>
  </table>
