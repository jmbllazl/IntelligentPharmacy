...
<table>
  查看的库存：
  <select  name="drugClassificationAllStyleList" id="styleShowListId" onchange="changeStyle()">
    <option value="" style='display:none;'>-请选择-</option>
    <option value="药房">药房库存</option>
    <option value="药库" >药库库存</option>
    </select >
  <td class="ctybtn">
