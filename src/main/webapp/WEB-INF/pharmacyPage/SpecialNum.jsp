  ...
  <table class="tablelist">
    ...
    <tr>
      ...
      <td colspan="9" align="right">
        <a href="/anesthesia/anesthesiaAllShowList.action?pageNum=1&&state=2&&drugClassificationId=${requestScope.drugClassificationIdNum}"    target="main">首页</a>
        <a href="/anesthesia/anesthesiaAllShowList.action?pageNum=${specialAllPageList.prePage}&&drugClassificationId=${requestScope.drugClassificationIdNum}&&state=2"  target="main">上一页</a>
        <a href="/anesthesia/anesthesiaAllShowList.action?pageNum=${specialAllPageList.nextPage}&&drugClassificationId=${requestScope.drugClassificationIdNum}&&state=2"  target="main">下一页</a>
        <a href="/anesthesia/anesthesiaAllShowList.action?pageNum=${specialAllPageList.navigateLastPage}&&drugClassificationId=${requestScope.drugClassificationIdNum}&&state=2"  target="main">尾页</a>
      </td>
    </tr> 
    </tbody>
  </table>
