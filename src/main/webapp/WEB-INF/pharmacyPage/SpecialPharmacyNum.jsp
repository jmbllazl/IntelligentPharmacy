...
<table>
  ...
  <td class="ctybtn">
    <a style="color: white"  href="/anesthesia/anesthesiaPharmacyNum.action" target="main" >查看所有特殊药房库存</a>
  </td>
</table>
  ...
  <table class="tablelist">
    ...
    <tr>
      ...
      <td colspan="9" align="right">
        <a href="/anesthesia/anesthesiaPharmacyNum.action?pageNum=1&&drugClassificationId=${requestScope.drugClassificationIdNum}"    target="main">首页</a>
        <a href="/anesthesia/anesthesiaPharmacyNum.action?pageNum=${specialAllPageList.prePage}&&drugClassificationId=${requestScope.drugClassificationIdNum}"  target="main">上一页</a>
        <a href="/anesthesia/anesthesiaPharmacyNum.action?pageNum=${specialAllPageList.nextPage}&&drugClassificationId=${requestScope.drugClassificationIdNum}"  target="main">下一页</a>
        <a href="/anesthesia/anesthesiaPharmacyNum.action?pageNum=${specialAllPageList.navigateLastPage}&&drugClassificationId=${requestScope.drugClassificationIdNum}"  target="main">尾页</a>
      </td>
    </tr> 
    </tbody>
  </table>
