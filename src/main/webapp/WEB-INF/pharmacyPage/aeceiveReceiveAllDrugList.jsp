...
<body>
<div class="x-nav"> <span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>麻醉精神药品销售明细</cite></a> </span> <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"  href="javascript:location.replace(location.href);" title="刷新"><i class="layui-icon" style="line-height:30px">ဂ</i></a> </div>
<div class="x-body">
...
<table>
  ...
  <td class="ctybtn">
    <a style="color: white"  href="/anesthesia/anesthesiaReceiveAllDrug.action?state=1" target="main" >查看所有特殊药品销售明细</a>
  </td>
</table>
  ...
  <table class="tablelist">
    ...
    <tr>
      ...
      <td colspan="9" align="right">
        <a href="/anesthesia/anesthesiaReceiveAllDrug.action?pageNum=1&&state=1"    target="main">首页</a>
        <a href="/anesthesia/anesthesiaReceiveAllDrug.action?pageNum=${specialAllPageList.prePage}&&state=1"  target="main">上一页</a>
        <a href="/anesthesia/anesthesiaReceiveAllDrug.action?pageNum=${specialAllPageList.nextPage}&&state=1"  target="main">下一页</a>
        <a href="/anesthesia/anesthesiaReceiveAllDrug.action?pageNum=${specialAllPageList.navigateLastPage}&&state=1"  target="main">尾页</a>
      </td>
    </tr> 
    </tbody>
  </table>
...
<script type="text/javascript">
  ...
  <script>
      function  changeStyle(){
          ...
          window.location.href="<%=request.getContextPath()%>/anesthesia/aeceiveReceiveAllDrugListId.action?state=1&&drugClassificationId="+id;
      }
