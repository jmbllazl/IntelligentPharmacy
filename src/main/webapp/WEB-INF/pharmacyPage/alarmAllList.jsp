  ...
  <table class="tablelist">
        ...
        <c:forEach items="${sessionScope.alarmPageList.list}" var="alramList">
            <tr>
              ...
              <td class="ctybtn"  style=" align: center">
                <a style="color: white"  href="/alarm/alarmManage.action?alarmId=${alramList.alarmId}&&alarmStyleId=${alramList.alarmStyleId}" target="main" >查看详情</a>
              </td>
            </tr>
        </c:forEach>
      </c:when>
    ...
    <tr>
      ...
      <td colspan="9" align="right">
        <a href="/alarm/alarmAllList.action?pageNum=1"    target="main">首页</a>
        <a href="/alarm/alarmAllList.action?pageNum=${alarmPageList.prePage}"  target="main">上一页</a>
        <a href="/alarm/alarmAllList.action?pageNum=${alarmPageList.nextPage}"  target="main">下一页</a>
        <a href="/alarm/alarmAllList.action?pageNum=${alarmPageList.navigateLastPage}"  target="main">尾页</a>
      </td>
    </tr> 
    </tbody>
  </table>
