...
<script type='text/javascript' >
    $(document).ready(function() {
        ...
        function SeriesData(drugName){
            $.post("/phamacy/batchList.action",{"drugName":drugName,"state":8},function(data,statues){
...
<script>
    layui.use(['form','element','jquery'], function() {
        ...
        $(document).on('click','#week',function(){
            $.post("/phamacy/batchList.action",{"drugName":drugName,"state":9},function(data,statues){
                var chart=new Highcharts.Chart({
                    //常规图表选项设置
                    chart: {
                        renderTo: 'container',        //在哪个区域呈现，对应HTML中的一个元素ID
        ...
        $(document).on('click','#mouth',function(){
            $.post("/phamacy/batchList.action",{"drugName":drugName,"state":10},function(data,statues){
                var chart=new Highcharts.Chart({
                    //常规图表选项设置
                    chart: {
                        renderTo: 'container',        //在哪个区域呈现，对应HTML中的一个元素ID
