...
<body>
<div class="x-nav"> <span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>药房药品调价</cite></a> </span> <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"  href="javascript:location.replace(location.href);" title="刷新"><i class="layui-icon" style="line-height:30px">ဂ</i></a> </div>
<div class="x-body">
  ...
  <table class="tablelist">
    ...
    <tr>
      ...
      <td colspan="9" align="right">
        <a href="/report/priceReceiveDrugList.action?pageNum=1"    target="main">首页</a>
        <a href="/report/priceReceiveDrugList.action?pageNum=${phamacyReceive.prePage}"  target="main">上一页</a>
        <a href="/report/priceReceiveDrugList.action?pageNum=${phamacyReceive.nextPage}"  target="main">下一页</a>
        <a href="/report/priceReceiveDrugList.action?pageNum=${phamacyReceive.navigateLastPage}"  target="main">尾页</a>
      </td>
    </tr> 
    </tbody>
  </table>
