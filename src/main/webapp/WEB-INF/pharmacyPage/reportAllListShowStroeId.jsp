...
<body>
<div class="x-nav"> <span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>药库药品明细</cite></a> </span> <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"  href="javascript:location.replace(location.href);" title="刷新"><i class="layui-icon" style="line-height:30px">ဂ</i></a> </div>
<div class="x-body">
...
<table>
  ...
  <td class="ctybtn">
    <a style="color: white"  href="/report/reportAllList.action?state=2" target="main" >查看所有药库药品</a>
  </td>
</table>
  ...
  <table class="tablelist">
    ...
    <tr>
      ...
      <td colspan="9" align="right">
        <a href="/report/reportAllListShowList.action?pageNum=1&&drugClassificationId=${requestScope.drugClassificationIdNum}&&state=2"    target="main">首页</a>
        <a href="/report/reportAllListShowList.action?pageNum=${specialAllPageList.prePage}&&drugClassificationId=${requestScope.drugClassificationIdNum}&&state=2"  target="main">上一页</a>
        <a href="/report/reportAllListShowList.action?pageNum=${specialAllPageList.nextPage}&&drugClassificationId=${requestScope.drugClassificationIdNum}&&state=2"  target="main">下一页</a>
        <a href="/report/reportAllListShowList.action?pageNum=${specialAllPageList.navigateLastPage}&&drugClassificationId=${requestScope.drugClassificationIdNum}&&state=2"  target="main">尾页</a>
      </td>
    </tr> 
    </tbody>
  </table>
...
<script type="text/javascript">
  ...
  <script>
      function  changeStyle(){
          ...
          window.location.href="<%=request.getContextPath()%>/report/reportAllListShowList.action?state=2&&drugClassificationId="+id;
      }
