        ...
        <c:choose>
            <c:when test="${not empty requestScope.phamacyReceive.list}">
                <c:forEach items="${requestScope.phamacyReceive.list}" var="receiveDrugTemp"   varStatus="status">
                    ...
                    <td><img style="width: 150px;height: 100px" src="${pageContext.request.contextPath}/userPage/images.action?receiverId=${receiveDrugTemp.pharmacyId}">
                    <br>${receiveDrugTemp.drugName}
                    <br><input type="button" value="查看详情" onclick="user_management_show('药品信息','selectPhamacyDrugReceiveDetils.action?receiverId=${receiveDrugTemp.pharmacyId}','600','500')">
                    </td>
